...
cl = LINEVIT.LINE()
cl.login(token="ErclyWoJxrgLJ7HePz1f.BiQRBUfNPzA/lpbf7I/q3W.R1/iA+MrHH8k4tS6UGEBHS8uel/88mhTODtjM7ahUss=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u6c8aab6ee167a596be2cf045ee2f90df",mid]
self = ["u6c8aab6ee167a596be2cf045ee2f90df",mid]
admin = "u6c8aab6ee167a596be2cf045ee2f90df"
admsa = "u6c8aab6ee167a596be2cf045ee2f90df"
owner = "u6c8aab6ee167a596be2cf045ee2f90df"
adminMID = "u6c8aab6ee167a596be2cf045ee2f90df"
Creator="u6c8aab6ee167a596be2cf045ee2f90df"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
#===================================================
                        ...
                        cl.sendText(msg.to,"ปิด ระบบกันรัน\nเรียบร้อยแล้ว.👌.")
#=====================================================
...
#========================================#
            ...
            elif msg.text in ["Add:on","เปิด เพิ่มเพื่อน","Auto add:on","เปิดเพิ่มเพื่อน"]:
                if wait["autoAdd"] == False:
                    ...
                    wait["autoAdd"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ปิด ระบบออโต้บล็อก\เรียบร้อยแล้ว..👌")
                    else:
                        cl.sendText(msg.to,"ระบบออโต้บล็อก\nถูกปิดใช้งานอยู่แล้ว..👌")

            elif msg.text in ["Add:off","Auto add off","ปิด เพิ่มเพื่อน","ปิดเพิ่มเพื่อน"]:
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
...
# ----------------- BAN MEMBER BY TAG 2TAG ATAU 10TAG MEMBER
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            elif msg.text in ["/ปิดเพิ่มเพื่อน"]:
                        cl.sendText(msg.to,"ปิดเพิ่มเพื่อน")
