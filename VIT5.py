            ...
            if mid in op.param3:
                ...
                if wait["autoJoin"] == True:
                    if wait["autoCancel"]["on"] == True:
                        ...
                        cl.sendText(op.param1, "อ้าอาาา ทำอะไรอะ  อย่าดึงมั่วสิคร๊าบ")
                    else:
                        cl.acceptGroupInvitation(op.param1)
                        cl.sendText(op.param1, "ติดเซลล์โปรดส่งลิ้งให้ในส่วนตัว")
...
#================================= 
                ...
                if wait["Backup"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Sudah off Bos\n\n"+ datetime.today().strftime('%H:%M:%S'))
#===========================================#
            elif "สลาย: " in msg.text:
                if msg.from_ in admin:
                   gids = msg.text.replace("สลาย: ","")
