...
cl = LINEVIT.LINE()
cl.login(token="EruKJHzgzzcUN2N2oax9.8l1jChCFjQJo9MrZ1zVmAq.A5m4IJz8girQO+D7Da3y80D0GoBS2ID+VKDQGxI6cnw=")
cl.loginResult()
    ...
    try:
        ...
        if op.type == 5:
            if wait["autoBlock"] == True:
                cl.blockContactBymid(op.param1
...
#========================================#
            ...
            elif msg.text in ["Add:on","เปิด เพิ่มเพื่อน","Auto add:on","Add on","เปิดเพิ่มเพื่อน"]:
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah on Bosqu")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Sudah on Bosqu")
            elif msg.text in ["Add:off","Auto add off","ปิด เพิ่มเพื่อน","Add off","ปิดเพิ่มเพื่อน"]:
            ...
            elif msg.text in ["Block on","เปิด ออโต้บล็อค","เปิดออโต้บล็อค","เปิดบล็อค]:
                if wait["autoBlock"] == True:
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["Block off","ปิด ออโต้บล็อค","ปิดออโต้บล็อค","ปิดบล็อค"]:
