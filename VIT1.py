...
#========================================
                ...
                if wait["autoBlock"] == True: md+="􀬁􀆐􏿿 ระบบป้องกัน รันกลุ่ม : ✔ 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 ระบบป้องกัน รันกลุ่ม : ❌ 􀜁􀄰􏿿\n"
...
#========================================
                ...
                group_name = Textreplace('ออกนะ:','')
                G = f.getGroupIdsJoined()
                cgroup = f.getGroups(G)
                  ...
                  if group_name == cgroup[x].name:
                      try:
                         cl.leaveGroup(cgroup[x].id)
                          ...
                          pass
                      try:
                         ki1.leaveGroup(cgroup[x].id)
                      except:
                          pass
                      try:
                         ki2.leaveGroup(cgroup[x].id)
                      except:
                          pass
                      try:
                         ki3.leaveGroup(cgroup[x].id)
                      except:
                          pass
                      try:
                         ki4.leaveGroup(cgroup[x].id)
                      except:
                          pass
                      try:
                         ki5.leaveGroup(cgroup[x].id)
                      except:
                          pass
                      try:
                         ki6.leaveGroup(cgroup[x].id)
                      except:
                          pass
                      try:
                         ki7.leaveGroup(cgroup[x].id)
                      except:
                          pass
                      try:
                         ki8.leaveGroup(cgroup[x].id)
                      except:
                          pass
                      try:
                         ki9.leaveGroup(cgroup[x].id)
                      except:
                          pass
                      try:
                         ki10.leaveGroup(cgroup[x].id)
                      except:
                          pass
                cl.sendText(msg.to," ออกจากลุ่มดังกล่าว\nเรียบร้อยแล้ว.👌")
#=======================================
...
#========================================#
            ...
            elif msg.text in ["AutoBlock on","เปิด บล็อก","เปิดกันรัน","เปิด กันรัน"]:
                if wait["autoBlock"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ระบบป้องกัน การรัน\nถูกเปิดอยู่แล้ว.👌")
                    else:
                        cl.sendText(msg.to,"เปิดระบบป้องกัน การรันกลุ่ม\nเรียบร้อยแล้ว.👌")
                else:
                    wait["autoBlock"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"เปิดระบบป้องกัน การรันกลุ่ม\nเรียบร้อยแล้ว.👌")
            ...
            elif msg.text in ["AutoBlock off","ปิด บล็อก","ปิดกันรัน","ปิด กันรัน"]:
                if wait["autoBlock"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ระบบป้องกัน การรัน\nถูกปิดอยู่แล้ว.👌")
                    else:
                        cl.sendText(msg.to,"ปิดระบบป้องกัน การรันกลุ่ม\nเรียบร้อยแล้ว.👌")
                else:
