...
self = ["",mid,Amid1,Amid2Amid3,Amid4,Amid5]
admin = ""
admsa = ""
owner = ""
adminMID = ""
...
#====================================
                ...
                try:
                    ...
                    cl.sendText(msg.to, "คิกเกอร์ ทั้งหม\nได้กลับคืนร่าง มหาเทพแล้ว")
                except Exception as e:
                    cl.sendText(msg.to, str (e))
