...
cl = LINEVIT.LINE()
cl.login(token="Eq0vUzYUPM6ewF3jk4P9.8l1jChCFjQJo9MrZ1zVmAq.T0ATkj913PiXDoCUasEbbM+dy7DkxaO7F9q43Z29v0w=")
cl.loginResult()

ki1 = LINEVIT.LINE()
ki1.login(token="EqQvstnimHWyezvp3Ul4.XINj+F5glECpGUFBv9dqra.K0wismRRoJls3/kmGn2wh2cHRlkQBZKOYyJHb1Lu0Tc=")
ki1.loginResult()

ki2 = LINEVIT.LINE()
ki2.login(token="EqVVsNBuEgZa6Nxx3YM6.SE4xiYeRrnCww6xd5+ih1G.qhYCSwdBm7tlKcNuuxOqtItjHCgjTaRn/RFYVpH6ACY="(
ki2.loginResult()

ki3 = LINEVIT.LINE()
ki3.login(token="EqaBWPqyc3DgXL5kXiI4.2TsPhKLEWHLdZ31t7VPjna.fHCaJucnGjcyyTPkaiLt9ByTIIMfW0/GpYkBLzdntuY=")
ki3.loginResult()

ki4 = LINEVIT.LINE()
ki4.login(token="EqLsR2Z1Upd7UO9bcnl1.IuAyTfx866qVm/1MtU8b8q.ntxAPj6B6lN4wurimPgXYRL35dGoflC9PYoVDOVZvg8=")
ki4.loginResult()

ki5 = LINEVIT.LINE()
ki5.login(token="EqhYwZHXtEUfP1MUoI13.8qQamNOV6o03LTfh4mWvCW.eT9FgszRRzJrnMxc+zoI5nLQZSgmjAoj1fe4TAilzoo=")
ki5.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["uf0bd4970771f26a8cef66473d59bcc69",mid,Amid1,Amid2,Amid3,Amid4,Amid5]
self = ["uf0bd4970771f26a8cef66473d59bcc69",mid,Amid1,Amid2,Amid3,Amid4,Amid5]
admin = "uf0bd4970771f26a8cef66473d59bcc69"
admsa = "uf0bd4970771f26a8cef66473d59bcc69"
owner = "uf0bd4970771f26a8cef66473d59bcc69"
adminMID = "uf0bd4970771f26a8cef66473d59bcc69"
